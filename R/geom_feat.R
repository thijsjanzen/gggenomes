...
#' For example, specific regions within a sequence (e.g. transposons, introns,
#' mutation hotspots) can be highlighted by color, size, etc..
#'
#' @details
...
#'
#' @param data feat_layout: Uses first data frame stored in the `feats` track
#' by default.
#' @param position describes how the position of different plotted features are
#' adjusted. By default it uses `"pile"`, but different ggplot2 position
